...
idade_Atua.setText(null);
  ...
  //setar combobx
  void item(){
Nsa.user=DadosCadastrais.k; 
//Nsa.user=Nsa.Mb;  //consertar a position in vetor
// --Nsa.user;
habilidade_Atua.setSelectedItem(Nsa.member[Nsa.user].getHabilidade());
cargo_Atua.setSelectedItem(Nsa.member[Nsa.user].getCargo());
    }
